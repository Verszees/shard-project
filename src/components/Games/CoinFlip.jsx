    ...
    >
      <div className="absolute top-4 left-4 z-20 pointer-events-none">
        ...
        <div className="flex items-center gap-1.5 mt-2">
          ...
          <p className="text-[8px] font-black text-blue-400 uppercase tracking-widest">Win x2</p>
        </div>
      </div>

      {/* Обертка для ПНГ и свечения с фиксом мерцания */}
      <div className="absolute bottom-[14%] right-[-5%] w-[80%] h-[75%] z-10 pointer-events-none transform-gpu" style={{ backfaceVisibility: 'hidden' }}>
        {/* Подсветка: добавил will-change и translate-z-0 для стабильности */}
        <div className="absolute inset-0 bg-blue-500/15 blur-[25px] rounded-full will-change-[filter] transform-gpu" style={{ transform: 'translateZ(0)' }} />
        <img
          src="/coinflip.png"
          alt="Coin"
